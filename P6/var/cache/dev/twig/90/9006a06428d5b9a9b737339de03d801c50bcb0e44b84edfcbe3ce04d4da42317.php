...
class __TwigTemplate_26f50fd59eacc7ad0cc0be18189858bb7e22e6ff8aa35a8f7636932db4308edc extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    {
        return new Source("{#<form method=\"post\" action=\"{{ path('category_delete', {'name': category.name}) }}\" onsubmit=\"return confirm('Are you sure you want to delete this {{category.getName}}?');\">
    <input type=\"hidden\" name=\"_method\" value=\"DELETE\">
    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ category.name) }}\">
    <a href=\"{{path('category_delete',{'name':category.name})}}\" type=\"button\" class=\"btn btn-danger\">
                    Delete</a>
   
</form

#}", "category/delete.html.twig", "/home/gilles/DEV/snowtrick/P6/templates/category/delete.html.twig");
    }
}
