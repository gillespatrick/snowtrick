...
class __TwigTemplate_f060c411581e7844361bae94a6e1141dce0c99dd08b9a1d4929556b1061126c7 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <div class=\"container\">
        ...
        echo "
                ...
                <h5>";
        // line 18
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["category"]) || array_key_exists("category", $context) ? $context["category"] : (function () { throw new RuntimeError('Variable "category" does not exist.', 18, $this->source); })()), "description", [], "any", false, false, false, 18), "html", null, true);
        echo "</h5><br><br><br><br>
...
";
    ...
    {
        return array (  116 => 23,  111 => 21,  105 => 18,  99 => 15,  89 => 7,  79 => 6,  59 => 3,  36 => 1,);
    }
    ...
    <div class=\"container\">
        ...
        <div class=\"row\">
            <div class=\"col s12 m12\">
                ...
                <h5>{{category.description}}</h5><br><br><br><br>
...
{% endblock %}
", "category/show.html.twig", "/home/gilles/DEV/snowtrick/P6/templates/category/show.html.twig");
    }
}
