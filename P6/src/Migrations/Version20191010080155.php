 ...
 */
final class Version20191010080155 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE trick ADD slug VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, CHANGE category_id category_id INT DEFAULT NULL, CHANGE user_id user_id INT DEFAULT NULL');
